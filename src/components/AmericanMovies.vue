...
export default {
    ...
    created() {
        console.log('created');
        axios
            .get('https://api.themoviedb.org/3/discover/movie?api_key=06a9b62fd61f37d8abcc00ee0a9a008f&language=fr&sort_by=revenue.desc&include_adult=false&include_video=false&page=1&with_original_language=en&vote_count.gte=1000&page=1')
            .then(res => {
